...
export default async function Page() {
  return (
    <div className="w-full overflow-x-hidden">
      <div className="w-screen min-h-screen flex lg:flex-row flex-col gap-4 lg:px-28 lg:py-36 lg:items-center lg:justify-center bg-[#030712]">
        <div className="lg:pl-40 px-4 py-34 text-white lg:py-10 lg:pr-10 flex flex-col gap-12 lg:gap-8 justify-center lg:w-1/2 h-full">
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-black tracking-tighter text-white leading-[1.1] group select-none lg:pr-28">
            Transforming Ideas into{" "}
            <span className="block sm:inline bg-linear-to-r from-blue-400 via-indigo-300 to-violet-400 bg-clip-text text-transparent transition-all duration-500 ease-out group-hover:drop-shadow-[0_0_35px_rgba(99,102,241,0.6)]">
          ...
          <div className="flex gap-4 justify-between lg:justify-normal">
            <Link
              href="/contact"
              className="group relative flex items-center lg:gap-3 px-2 py-4 lg:px-8 lg:py-4 font-semibold text-white rounded-2xl bg-linear-to-r from-indigo-600 to-violet-600 shadow-[0_0_20px_rgba(99,102,241,0.2)] hover:shadow-[0_0_40px_rgba(99,102,241,0.4)] hover:-translate-y-1 transition-all duration-300 overflow-hidden lg:text-sm text-xs"
            >
              Get A Free Consultation
              <ArrowRightIcon className="w-5 h-5 group-hover:translate-x-1.5 ml-2 lg:ml-0 transition-transform duration-300 ease-out" />
            </Link>

            <Link
              href="/project"
              className="flex items-center justify-center lg:text-sm text-xs py-4 px-5 lg:px-8 lg:py-4 font-semibold text-slate-300 rounded-2xl bg-[#030712]/50 backdrop-blur-md border border-slate-700/50 hover:bg-slate-800/50 hover:text-white hover:border-indigo-500/50 hover:shadow-[0_0_20px_rgba(99,102,241,0.15)] hover:-translate-y-1 transition-all duration-300"
            >
              View Our Work
            </Link>
          </div>
        ...
        <div className="relative lg:w-1/2 h-[600px] flex items-center justify-center pointer-events-none">
